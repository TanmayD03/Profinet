...
print("\n" + "="*60)
print("PHASE 13: The Triumph (Hex-Perfect Object UUID)")
print("="*60)
...
def build_rpc_header(activity_uuid, seq_num, opnum, payload_len):
    ...
    # THE FINAL FIX: Vendor(1559) + Device(1503) + Instance(0001)
    obj_uuid_str = "dea00000-6c97-11d1-8271-155915030001"
    
    hdr += uuid.UUID(obj_uuid_str).bytes_le                           
...
def check_rpc_response(resp, step_name):
    ...
    if ptype == 0x02: return True, "Accepted"
        ...
        reasons = {
            0x1c010003: "nca_unk_if (Unknown Interface - The UUID is still wrong)",
            0x1c010006: "nca_wrong_boot_time (Ghost AR Lock - Power cycle the relay!)",
            0x1c01000b: "nca_wrong_boot_time (Ghost AR Lock - Power cycle the relay!)"
        }
...
try:
    ...
    print(f"1. Sending AR Connect using TeSys Tera UUID (155915030001)...")
